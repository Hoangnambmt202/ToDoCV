...
import { ArrowPathRoundedSquareIcon, ArrowRightEndOnRectangleIcon, BellIcon, CalendarDaysIcon, PaperClipIcon, PlusIcon, StarIcon, TagIcon, TrashIcon } from '@heroicons/vue/24/outline';
...
<template>
  <div
    ...
    :class="ui.showRightSidebar == true ? 'w-96' : 'w-0 '">
    <div v-if="ui.showRightSidebar" class="p-4 flex-1">
      <!-- Update task input -->
        ...
        <div v-if="taskStore.selectedTask" class="flex items-center flex-col space-y-2">
          <div class="flex items-center gap-2 w-full">
            ...
            <input v-model="taskStore.selectedTask.title"
              class="w-full p-2 border-b border-b-gray-500 focus:outline-none" @change="saveChanges" />
      ...
      <div class="overflow-y-scroll overflow-hidden bg-white max-h-full">
        ...
        <div v-if="taskStore.selectedTask.due_date" class="bg-white w-full shadow py-4 hover:bg-gray-100  ">
          <div class="flex gap-2 ">
        ...
        <div v-else class="bg-white w-full shadow py-4 hover:bg-gray-100  ">
          <div class="flex gap-2 ">
            <CalendarDaysIcon class="w-6 h-6 text-black" />
  ...
  <div id="deleteModal" v-if="showDeleteModal" tabindex="-1"
    ...
    <div class="relative top-1/2 left-1/3 p-4 w-full opacity-100 max-w-md h-full md:h-auto">
      ...
      <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <button type="button" @click="showDeleteModal.value = false"
